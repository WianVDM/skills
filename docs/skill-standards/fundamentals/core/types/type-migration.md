...
See [`../failure-recovery/split-prune-retire.md`](../failure-recovery/split-prune-retire.md) for the operational side of splitting and retiring skills and [`../../../guides/migrate-a-skill.md`](../../../guides/migrate-a-skill.md) for migration steps.
