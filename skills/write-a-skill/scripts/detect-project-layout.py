...
asks the user. It is used by the `write-a-skill` conductor to avoid hardcoding
`.agents/` paths.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Detect project layout for skill tooling."
    )
    parser.add_argument(
