...
| `explore_code_project_root` | string | `null` | Default project root directory used to resolve `workspace` and relative paths. |
| `explore_code_force` | boolean | `false` | When true, run exploration even for `process` task types. |
